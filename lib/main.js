window.onload = function() {
  ...
  function generateRandomPipes (context, canvasObject) {
    ...
    let returnVal = {};
    returnVal.top = new Pipe(canvasObject.width, -5, lengthTop, 20, context);
    returnVal.bottom = new Pipe(canvasObject.width, canvasObject.height + 5 - lengthBottom, lengthBottom, 20, context);
    return returnVal;
  }
