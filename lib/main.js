window.onload = function() {
  ...
  canvas.width = 2000;  canvas.height = 617;
  ...
  function generateRandomPipes(context, canvasObject) {
    ...
    returnVal.bottom = new Pipe(canvasObject.width, canvasObject.height + 10 - lengthBottom, lengthBottom, 10, context);
    return returnVal;
  }
...
Pipe.prototype.render = function() {
  ...
  this.ctx.fillRect(this.xPos, this.yPos, 110, this.length);
  this.ctx.fillStyle = '#74BF2E';
  this.ctx.fillRect(this.xPos + 5, this.yPos + 5, 100, this.length - 10);
  this.ctx.restore();
};
